    ...
    <div className="min-h-screen flex">
      ...
      >
        <div className="w-full max-w-md">
          ...
          <h1 className="font-playfair text-4xl text-cream mb-2">Start your story.</h1>
          <p className="text-parchment text-sm mb-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-parchment text-sm">
              ...
              <Link href="/login" className="text-gold hover:text-goldHover transition-colors">
                Sign in
              </Link>
            </p>
          </div>
